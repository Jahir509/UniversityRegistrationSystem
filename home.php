		...
		<table border="4px solid black">
		 ...
		 ?>
			...
			<?php
	   	    ...
	   	    ?>
		 	<tr>
			<td><font color="green" weight="bold" size="4px"><?= $rowa['Date'];?></td>
			<td><font color="green" weight="bold" size="4px"><?=  $rowa['Day'];?></td>
			<td><font color="green" weight="bold" size="4px"><?=  $rowa['Details'];?></td>
			</tr>
			<?php
			   }
			 else{  
